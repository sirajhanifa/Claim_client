                                ...
                                {fetchLoading ? (
                                    ...
                                    <tr key={user._id || index} className="hover:bg-slate-50/80 transition-colors group">
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <div className="flex items-center justify-center gap-2 text-slate-800 text-sm bg-slate-100 w-fit px-2 py-1 rounded mx-auto">
                    ...
                    <div className="relative bg-white rounded-[1.5rem] shadow-2xl w-full max-w-2xl overflow-hidden border-t-[6px] border-blue-600 animate-in slide-in-from-bottom-8 duration-300">
                        <div className="p-8">
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <h2 className="text-xl font-black text-slate-900 leading-tight">{editingUser ? 'Edit Account' : 'Create Account'}</h2>
                                    <p className="text-slate-400 text-xs font-bold uppercase tracking-wider">{editingUser ? 'Update Credentials' : 'Credentials Setup'}</p>
                                </div>
                            </div>

                            <p className="text-slate-500 text-sm mb-8 font-medium">
                                {editingUser ? 'Update the login credentials for this user.' : 'Set up unique login credentials for the new user. These will be required for system access.'}
                            </p>
