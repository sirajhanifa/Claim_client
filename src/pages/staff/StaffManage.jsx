...
const StaffManage = () => {
    ...
    return (
        <div className=''>
            ...
            <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-green-700 border border-slate-200 text-white  px-5 py-2.5 rounded-xl font-bold hover:bg-green-800 transition-all shadow-sm"
                    >
            ...
            {/* 2. Data Operations Bar */}
            <div className="flex flex-col xl:flex-row items-stretch justify-between gap-6 mt-8">
                <div className="flex flex-col sm:flex-row items-center gap-4 border bg-white border-slate-200 rounded-[10px] p-4 shadow-sm">
                    ...
                    <div className="relative group w-80">
                        ...
                        <div className="flex items-center gap-3 px-4 py-3 bg-slate-50 rounded-[10px] border-2 border-dashed border-slate-200 group-hover:border-blue-400 group-hover:bg-blue-50/50 transition-all duration-200">
                            <div className="py-2 bg-white rounded-md shadow-sm border border-slate-100 group-hover:scale-110 transition-transform">
                                <ImagePlus className="w-8 h-3 text-slate-400 group-hover:text-blue-500" />
                            </div>
                            <div className="flex flex-row items-center pr-4">
                                ...
                                <span className="text-[11px] ml-3 text-slate-400 font-medium">
                ...
                <div>
                    <div className="flex justify-end gap-4 w-full xl:w-auto mt-6">
