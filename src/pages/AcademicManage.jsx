...
const AcademicManage = () => {
    ...
    useEffect(() => {
        if (academics.length && sortConfig.originalOrder.length === 0) {
            setSortConfig(prev => ({ ...prev, originalOrder: [...academics] }));
        }
    }, [academics]);
    ...
    return (
        <div className="min-h-screen">
                        ...
                        <table className="w-full text-sm border-collapse">
                                ...
                                <tr className="bg-slate-50/90">
                                    ...
                                    >
                                        <span className="inline-flex items-center gap-1">
                                            Semester Label {getSortIcon('academic_sem_label')}
                                        </span>
                                    </th>
                                    <th
                                        className="px-6 py-4 font-bold text-slate-600 uppercase text-[11px] tracking-wider text-center cursor-pointer hover:text-blue-600 transition-colors select-none border-b border-slate-200"
                                    ...
                                    >
                                        <span className="inline-flex items-center gap-1">
                                            Type {getSortIcon('academic_sem_type')}
                                        </span>
                                    </th>
                                    <th
                                        className="px-6 py-4 font-bold text-slate-600 uppercase text-[11px] tracking-wider text-center cursor-pointer hover:text-blue-600 transition-colors select-none border-b border-slate-200"
                            ...
                            <tbody>
                                {fetchLoading ? (
                                    ...
                                    sortedAcademics.map((academic, idx) => (
                                        <tr key={academic._id || idx} className="hover:bg-slate-50/50 transition-colors">
            ...
            {/* Professional Modal – matches AddUser modal styling */}
            {openModal && (
                        ...
                        <div className="p-8 max-h-[65vh] overflow-y-auto">
                            <form onSubmit={handleSubmit} id="academic-form" className="space-y-6">
                                <div className="grid grid-cols-1 gap-6">
                                    ...
                                    {/* Semester Type & Academic Year grid */}
